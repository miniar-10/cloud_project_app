...
// const db_con=require("./db.js")
const usersCtrl=require("../controllers/index.js")
...
usersRouter.get("/add", usersCtrl.addUser);
usersRouter.post("/add",usersCtrl.postAddUser)
...
//     db_con.query("INSERT INTO customer set ?", [newUser], () => {
//       res.redirect("/");
//     });
